   ...
   /**
    ...
    handleDeleteLink: function(event) {
        ...
        const cartRetrieved = cart.getCart();
         //alert(cartRetrieved);
        // Nous bouclons sur le panier pour trouver l'article à supprimer
    ...
    postData: function(objectContact, arrayProducts) {
        ...
        if (objectContact !== undefined && arrayProducts !== undefined) {
            ...
            // Nous ajoutons dans le body de la requête les 2 données attendues par l'API
            body: JSON.stringify({contact: objectContact, products: arrayProducts}) 
            };
